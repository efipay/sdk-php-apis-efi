...
$body = [
	...
	"envia_email" => true,
	"comprimir_arquivos" => false // true - arquivo compactado em formato .zip / false - arquivo não compactado em formato .txt
];

try {
	$api = new EfiPay($options);
	$response = $api->createStatementRecurrency($params = [], $body);
