...
$body = [
    ...
    "status" => "revogado",
    // "nomeFavorecido" => "Gorbadoc Oldbuck",
    // "dataExpiracao" => "2028-06-10", // "YYYY-mm-dd" or "indeterminado"
    // "valorMaximo" => "500.00", // foat number or "indefinido"
];

try {
    $api = new EfiPay($options);
    $response = $api->ofUpdateAutomaticEnrollment($params = [], $body);
