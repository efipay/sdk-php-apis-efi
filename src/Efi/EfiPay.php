 ...
 * @method object ofCreateAutomaticPixPayment(array $params = [], array $body)
 * @method object ofListAutomaticPixPayment(array $params)
 * @method object ofCancelAutomaticPixPayment(array $params)
 * 
 * API PAYMENTS
